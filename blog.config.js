...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '582f8a4487644df4b8ad74651f16e23a',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '1eafyz', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '哈哈一个普通的干饭人🍚', // 作者简介
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.1eafyz.top', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
